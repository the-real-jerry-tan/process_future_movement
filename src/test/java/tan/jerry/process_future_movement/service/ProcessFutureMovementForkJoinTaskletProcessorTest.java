...
/**
 * Unit tests for ProcessFutureMovementForkJoinTaskletProcessor.
 * Includes simple and complex cases, with some marked as @Disabled for complex scenarios.
 */
class ProcessFutureMovementForkJoinTaskletProcessorTest {

    private ProcessFutureMovementForkJoinTaskletProcessor processor;

    private Map<String, Double> expectedResults;

    @BeforeEach
    void setUp() {
        processor = new ProcessFutureMovementForkJoinTaskletProcessor();
    ...
    @Test
    void processTestMissingClientInfo() {
        Map<String, Double> result = processor.process("complex_case_missing_client_info.txt", "output9.csv");
    ...
    void testProcess_InvalidProductInfo() {
        Map<String, Double> result = processor.process("complex_case_invalid_product_info.txt", "output10.csv");
    ...
    void testProcess_NegativeTransactionAmount() {
        Map<String, Double> result = processor.process("complex_case_negative_transaction_amount.txt", "output11.csv");
    ...
    void testProcess_LargeTransactionAmount() {
        Map<String, Double> result = processor.process("complex_case_large_transaction_amount.txt", "output12.csv");
    ...
    void testProcess_ZeroTransactionAmount() {
        Map<String, Double> result = processor.process("complex_case_zero_transaction_amount.txt", "output13.csv");
    ...
    void testProcess_DuplicateRecords() {
        Map<String, Double> result = processor.process("complex_case_duplicate_records.txt", "output14.csv");
    ...
    void testProcess_EmptyFields() {
        Map<String, Double> result = processor.process("complex_case_empty_fields.txt", "output15.csv");
        assertTrue(result.containsKey("CL432100020001,SGXFUNK20100910"));
        assertEquals(0.0, result.get("CL432100020001,SGXFUNK20100910"));
    }
    ...
    void testProcess_UnusualCharacters() {
        Map<String, Double> result = processor.process("complex_case_unusual_characters.txt", "output16.csv");
        assertTrue(result.containsKey("CL123400030001,CMEFUN120100910"));
