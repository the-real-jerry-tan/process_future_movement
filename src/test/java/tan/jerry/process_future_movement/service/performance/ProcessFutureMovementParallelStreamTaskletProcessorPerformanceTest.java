...
import tan.jerry.process_future_movement.service.ProcessFutureMovementParallelStreamsTaskletProcessor;

import static org.junit.jupiter.api.Assertions.*;

/**
 * This class contains performance tests for the ProcessFutureMovementParallelStreamTaskletProcessor.
...
@SpringBootTest
@ActiveProfiles("test")
class ProcessFutureMovementParallelStreamTaskletProcessorPerformanceTest {

    private static final Logger logger = LoggerFactory.getLogger(ProcessFutureMovementParallelStreamTaskletProcessorPerformanceTest.class);
    private ProcessFutureMovementParallelStreamsTaskletProcessor processor = new ProcessFutureMovementParallelStreamsTaskletProcessor();
