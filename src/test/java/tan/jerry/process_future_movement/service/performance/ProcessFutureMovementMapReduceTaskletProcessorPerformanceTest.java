...
import tan.jerry.process_future_movement.service.ProcessFutureMovementMapReduceTaskletProcessor;

import static org.junit.jupiter.api.Assertions.*;

/**
 * This class contains performance tests for the ProcessFutureMovementMapReduceTaskletProcessor.
...
@SpringBootTest
@ActiveProfiles("test")
class ProcessFutureMovementMapReduceTaskletProcessorPerformanceTest {

    private static final Logger logger = LoggerFactory.getLogger(ProcessFutureMovementMapReduceTaskletProcessorPerformanceTest.class);
    private ProcessFutureMovementMapReduceTaskletProcessor processor = new ProcessFutureMovementMapReduceTaskletProcessor();
