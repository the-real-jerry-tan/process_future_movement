...
import tan.jerry.process_future_movement.service.ProcessFutureMovementForkJoinTaskletProcessor;

import static org.junit.jupiter.api.Assertions.*;

/**
 * This class contains performance tests for the ProcessFutureMovementForkJoinTaskletProcessor.
...
@SpringBootTest
@ActiveProfiles("test")
class ProcessFutureMovementForkJoinTaskletProcessorPerformanceTest {

    private static final Logger logger = LoggerFactory.getLogger(ProcessFutureMovementForkJoinTaskletProcessorPerformanceTest.class);
    private ProcessFutureMovementForkJoinTaskletProcessor processor = new ProcessFutureMovementForkJoinTaskletProcessor();
    ...
    @Test
    @Disabled("Disabled until enable.performance.tests is set to true")
