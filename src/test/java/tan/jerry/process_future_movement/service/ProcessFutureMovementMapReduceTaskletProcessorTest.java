...
/**
 * Unit tests for ProcessFutureMovementMapReduceTaskletProcessor.
 * Includes simple and complex cases, with some marked as @Disabled for complex scenarios.
 */
class ProcessFutureMovementMapReduceTaskletProcessorTest {

    private ProcessFutureMovementMapReduceTaskletProcessor processor;

    private Map<String, Double> expectedResults;

    @BeforeEach
    void setUp() {
        processor = new ProcessFutureMovementMapReduceTaskletProcessor();
